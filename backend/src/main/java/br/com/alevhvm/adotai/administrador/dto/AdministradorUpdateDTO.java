package br.com.alevhvm.adotai.administrador.dto;
...
@JsonPropertyOrder({ "nome", "email", "fotoPerfil", "celular" })
public class AdministradorUpdateDTO extends RepresentationModel<AdministradorUpdateDTO> implements Serializable {
