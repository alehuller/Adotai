...
public interface UsuarioControllerDocs {
    ...
    ResponseEntity<UsuarioDTO> atualizarParcialUsuario(Long id, Map<String, Object> updates);
    ...
    ResponseEntity<PagedModel<EntityModel<AdocaoDTO>>> listarAdocoesPorUsuarioId(Long id, int page, int size, String direction);
}
