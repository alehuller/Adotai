...
public interface UsuarioControllerDocs {
        ...
        ResponseEntity<PagedModel<EntityModel<AdocaoDTO>>> listarAdocoesPorNomeUsuario(String nomeUsuario, int page,
                        int size,
                        String direction);
        ...
        @Operation(summary = "Adiciona/remove um animal dos favoritos do usuário com toggle", responses = {
                        @ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Map.class))),
                        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
                        @ApiResponse(responseCode = "404", description = "Not Found", content = @Content),
                        @ApiResponse(responseCode = "500", description = "Internal Error", content = @Content)
        })
        ResponseEntity<Map<String, Object>> toggleFavorito(String nomeUsuario, Long animalId);

        @Operation(summary = "Lista todos os animais favoritos de um usuário", responses = {
        ...
        ResponseEntity<PagedModel<EntityModel<AnimalDTO>>> listarAnimaisFavoritos(String nomeUsuario, int page,
                        int size, String direction, String sort);
}